...
void setup() {
  ...
  //! ledmatrix.init();           // 初始化LED矩阵
  //! ledmatrix.setIntensity(1);  // 设置LED亮度
...
bool gaits(int cmd) {
  ...
  // 动作指令处理
  switch (cmd) {
    case 1: robot.run(0); break;              // 停止
    case 2: robot.run(1); break;              // 前进
    case 3: robot.turnL(1, 550); break;       // 左转
    case 4: robot.turnR(1, 550); break;       // 右转
    case 5: robot.home(); break;              // 归位
    case 6: robot.pushUp(); break;            // 俯卧撑
    case 7: robot.upDown(); break;            // 上下运动
    case 8: robot.waveHAND(); break;          // 挥手
    case 9: robot.Hide(); break;              // 隐藏
    case 10: robot.omniWalk(true); break;     // 全向行走(前)
    case 11: robot.omniWalk(false); break;    // 全向行走(后)
    case 12: robot.dance(1, 1000); break;     // 舞蹈1
    case 13: robot.frontBack(1, 750); break;  // 前后运动
    case 14: robot.jump(); break;             // 跳跃
    case 15: robot.scared(); break;           // 害怕动作
...
void receiveSing() {
  ...
  // 播放对应声音
  switch (sing) {
    case 1: robot.sing(S_connection); break;
    case 2: robot.sing(S_disconnection); break;
    case 3: robot.sing(S_surprise); break;
    case 4: robot.sing(S_OhOoh); break;
    case 5: robot.sing(S_OhOoh2); break;
    case 6: robot.sing(S_cuddly); break;
    case 7: robot.sing(S_sleeping); break;
    case 8: robot.sing(S_happy); break;
    case 9: robot.sing(S_superHappy); break;
    case 10: robot.sing(S_happy_short); break;
    case 11: robot.sing(S_sad); break;
    case 12: robot.sing(S_confused); break;
    case 13: robot.sing(S_fart1); break;
    case 14: robot.sing(S_fart2); break;
    case 15: robot.sing(S_fart3); break;
    case 16: robot.sing(S_mode1); break;
    case 17: robot.sing(S_mode2); break;
    case 18: robot.sing(S_mode3); break;
    case 19: robot.sing(S_buttonPushed); break;
    default: break;
  }
  sendFinalAck();
}
...
void receiveGesture() {
  ...
  // 执行对应手势
  switch (gesture) {
    case 1: robot.playGesture(OttoHappy); break;       // 开心手势
    case 2: robot.playGesture(OttoSuperHappy); break;  // 超级开心手势
    case 3: robot.playGesture(OttoSad); break;         // 悲伤手势
    case 7: robot.playGesture(OttoLove); break;        // 爱心手势
    default: break;
  }
